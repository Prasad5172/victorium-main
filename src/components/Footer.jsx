    ...
    <footer className="text-gray-400 bg-black body-font mt-10 md:mt-32 flex flex-col items-center ">
      ...
      <div className="container px-10 md:px-32 py-16 mx-auto justify-content-center">
        <div className="row justify-content-center d-flex">
          <center>
            <div className="col-lg-12 text-center d-flex" align="center">
              <a
                href="#products"
                className="title-font font-medium text-white tracking-widest text-sm mb-3 flex justify-center items-center"
              >
                Product
              </a>
